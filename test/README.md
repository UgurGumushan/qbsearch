...
- `plugin_sources.ts` is generated by `gen` and imports every plugin as text. This makes each
...
repository tests because the generated `plugin_sources.ts` imports those files
as text. Adding a plugin needs no test edits: `gen` regenerates the manifest.

...
class esmeraldatorrent:
    url: str = "https://esmeraldatorrent.com/"
    headers: ClassVar[dict[str, str]] = {"Referer": url}
    name: str = "EsmeraldaTorrent"
    ...
    class MyHtmlParser(HTMLParser):
        ...
        def handle_endtag(self, tag: str) -> None:
            ...
            if self.insideResult and tag == self.P:
                ...
                if desc_link and desc_link not in self.seen_links:
    ...
    def resolve_result(self, row: dict[str, str]) -> SearchResults | None:

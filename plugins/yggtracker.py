...
class yggtracker:
    name: str = "YGGtracker"
    url: str = "https://github.com/YGGverse/YGGtracker"
    ...
    def search(self, what: str, cat: str = "all") -> None:
        ...
        try:
            nodes_json = cast(list[YggNode], cast(object, json.loads(nodes)))
        ...
        for node in nodes_json:
            ...
            try:
                ...
                response_json = cast(YggNodeResponse, cast(object, json.loads(response)))
            except (KeyError, TypeError, ValueError):
                # Nodes are independently operated; one unavailable node must
                # not discard results from the rest of the registry.
                continue

...
class dontorrent:
    ...
    def threaded_search(self, page: int, what: str) -> None:
        ...
        retrieved_html = retrieve_url(page_url, headers, self.get_page_data(what, page))
    ...
    def search(self, what: str, _cat: str = "all") -> None:
        ...
        page = 1
        retrieved_html = retrieve_url(
            self.get_page_url(), self.headers, self.get_page_data(what, page)
        )
